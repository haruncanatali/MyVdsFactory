...
namespace MyVdsFactory.Persistence.Migrations
{
    ...
    [Migration("20230419210219_AuthorsAndBooks_Table_Added")]
    partial class AuthorsAndBooks_Table_Added
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyVdsFactory.Domain.Entities.Author", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MyVdsFactory.Domain.Entities.Book", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MyVdsFactory.Domain.Entities.Book", b =>
                {
                    b.HasOne("MyVdsFactory.Domain.Entities.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AurhorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
